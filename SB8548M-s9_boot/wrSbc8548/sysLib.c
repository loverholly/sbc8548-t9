...
void sysHwInit (void)
    ...
    *M85XX_BR1(CCSBAR)   = LBC_CS1_LOCAL_ADRS | 0x0801;
	*M85XX_OR1(CCSBAR)   = LBC_CS1_LOCAL_SIZE_MASK | 0xc80;
    *M85XX_BR2(CCSBAR)   = LBC_CS2_LOCAL_ADRS | 0x0801;
	*M85XX_OR2(CCSBAR)   = LBC_CS2_LOCAL_SIZE_MASK | 0xc80;
    *M85XX_BR4(CCSBAR)   = LBC_CS4_LOCAL_ADRS | 0x0801;
	*M85XX_OR4(CCSBAR)   = LBC_CS4_LOCAL_SIZE_MASK | 0xc80;
    *M85XX_BR5(CCSBAR)   = LBC_CS5_LOCAL_ADRS | 0x0801;
	*M85XX_OR5(CCSBAR)   = LBC_CS5_LOCAL_SIZE_MASK | 0xc80;
    *M85XX_BR6(CCSBAR)   = LBC_CS6_LOCAL_ADRS | 0x0801;
	*M85XX_OR6(CCSBAR)   = LBC_CS6_LOCAL_SIZE_MASK | 0xc80;
#endif	/* PRJ_BUILD */
