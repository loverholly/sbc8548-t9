...
# GENERATED: Mon Apr 10 23:24:32 +0900 2017
...
PRJ_TYPE       = vxWorks
PRJ_OBJS       = sysALib.o sysLib.o usrAppInit.o usrRtpAppInit.o prjConfig.o linkSyms.o test_file.o rs485ctl.o fsl_i2c.o i2cDrv.o extio.o temp.o usrFileUpdate.o
...
temp.o:  $(PRJ_DIR)/temp/temp.c 
	$(RM) temp.o
	$(CC) $(CFLAGS) $(CFLAGS_OPTIONS_ALL) -c $(PRJ_DIR)/temp/temp.c

usrFileUpdate.o:  $(PRJ_DIR)/usrFileUpdate.c 
	$(RM) usrFileUpdate.o
	$(CC) $(CFLAGS) $(CFLAGS_OPTIONS_ALL) -c $(PRJ_DIR)/usrFileUpdate.c
endif
